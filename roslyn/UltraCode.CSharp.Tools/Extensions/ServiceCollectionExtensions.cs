...
using UltraCode.CSharp.Tools.Infrastructure.Cache;
using UltraCode.CSharp.Tools.Ipc;
using UltraCode.CSharp.Tools.Layered;
using UltraCode.CSharp.Tools.Merge;
using UltraCode.CSharp.Tools.Merge.Analysis;
using UltraCode.CSharp.Tools.Merge.Engine;
using UltraCode.CSharp.Tools.Merge.Git;
using UltraCode.CSharp.Tools.Merge.Indexing;
using UltraCode.CSharp.Tools.Merge.Matching;
using UltraCode.CSharp.Tools.Merge.Parsing;
using UltraCode.CSharp.Tools.Models;
using UltraCode.CSharp.Tools.Semantic;
using UltraCode.CSharp.Tools.Semantic.Embedding;
using UltraCode.CSharp.Tools.Semantic.GPU;
using UltraCode.CSharp.Tools.Replace.Interfaces;
using UltraCode.CSharp.Tools.Replace.Services;
using UltraCode.CSharp.Tools.Semantic.Hybrid;
using UltraCode.CSharp.Tools.Mcp.Prompts;

namespace UltraCode.CSharp.Tools.Extensions;
...
public static class ServiceCollectionExtensions {
    ...
    public static IServiceCollection WithUltrasharpToolsServices(
        ...
        services.AddSingleton<UltraCode.CSharp.Tools.Preview.PreviewManager>();

        // Version manager for code snapshots
        services.AddSingleton<UltraCode.CSharp.Tools.Versioning.VersionManager>();
    ...
    public static IMcpServerBuilder WithUltrasharpTools(this IMcpServerBuilder builder) {
        var toolAssembly = Assembly.Load("UltraCode.CSharp.Tools");
    ...
    public static IServiceCollection WithSemanticReplace(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IBatchReplacerService>(sp => {
            ...
            var versionManager = sp.GetRequiredService<UltraCode.CSharp.Tools.Versioning.VersionManager>();
