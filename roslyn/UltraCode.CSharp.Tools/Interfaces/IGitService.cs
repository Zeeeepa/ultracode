namespace UltraCode.CSharp.Tools.Interfaces;
...
public interface IGitService
{
    ...
    Task<bool> IsOnSharpToolsBranchAsync(
        string solutionPath,
        CancellationToken cancellationToken = default
    );
    Task EnsureSharpToolsBranchAsync(
        string solutionPath,
        CancellationToken cancellationToken = default
    );
    ...
    Task<string> GetBranchOriginCommitAsync(
        string solutionPath,
        CancellationToken cancellationToken = default
    );
    Task<string> CreateUndoBranchAsync(
        string solutionPath,
        CancellationToken cancellationToken = default
    );
    ...
    Task<List<string>> CleanupOldBranchesAsync(
        string solutionPath,
    ...
    /// </summary>
    Task<string?> GetMergeBaseCommitAsync(
        string solutionPath,
        string branch1,
        string branch2,
        CancellationToken cancellationToken = default
    ...
    /// </summary>
    Task<List<(string FilePath, string ChangeType)>> GetChangedFilesAsync(
        string solutionPath,
