...
## Goal
Introduce Lerna-based workspace graph capabilities to the UltraScript Tools MCP server, enabling both internal dependency-aware workflows and an external MCP tool surface for other agents.
