...
| `printWarn` | function | Выводит жёлтое предупреждение о потенциальной проблеме | [→ setup-ui.ts:33-35] |
| `printError` | function | Выводит красное сообщение об ошибке при выполнении | [→ setup-ui.ts:37-39] |
| `prompt` | function | Интерактивно запрашивает ввод строки у пользователя через консоль | [→ setup-ui.ts:41-43] |
