...
|------|------|-------------|----------|
| `CustomDetectorFn` | type | Type for custom detector function signature | [→ types.ts:185] |
| `CustomDetectorResult` | interface | Interface for custom detector function result | [→ types.ts:167-181] |
...
| `PatternScanOptions` | interface | Interface for scan configuration and filtering options | [→ types.ts:149-163] |
| `PatternScanResult` | interface | Interface for complete scan results with summary | [→ types.ts:131-145] |
...
| `StructuralCandidate` | interface | Interface for pattern candidate before validation | [→ types.ts:167-181] |
| `StructuralCriteria` | interface | Interface for structural pattern matching requirements | [→ types.ts:24-83] |
