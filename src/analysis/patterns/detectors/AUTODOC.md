...
Language-agnostic and language-specific custom detectors for identifying code quality issues, anti-patterns, and performance problems across multiple programming languages.
