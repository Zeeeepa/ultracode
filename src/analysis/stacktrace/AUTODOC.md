...
Analyzes stacktraces by parsing, classifying errors, resolving frames to code entities, and generating diagnostics with suggested fixes.
...
| `LanguageStacktraceParser` | interface | Interface for language-specific parser implementations | [→ types.ts:142-146] |
...
| `resolveFrames` | function | Resolves stacktrace frames to code entities | [→ frame-resolver.ts:65-155] |
...
| `StacktraceDiagnosis` | interface | Complete diagnosis output with analysis | [→ types.ts:97-132] |
