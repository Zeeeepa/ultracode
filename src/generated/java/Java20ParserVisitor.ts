...
import type {
  ...
  ContextualKeywordContext,
  ContextualKeywordMinusForTypeIdentifierContext,
  ContextualKeywordMinusForUnqualifiedMethodIdentifierContext,
 ...
 */
export class Java20ParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
  /**
   ...
   * @return the visitor result
   */
  visitContextualKeywordMinusForUnqualifiedMethodIdentifier?: (
    ctx: ContextualKeywordMinusForUnqualifiedMethodIdentifierContext,
  ) => Result;
  /**
