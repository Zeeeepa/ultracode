...
| `CycleAnalysisResult` | interface | Результат анализа цикла с типом, серьёзностью и предложением. | [→ cycle-detector.ts:13-16] |
...
| `hasYieldExpression` | function | Проверяет наличие выражения yield в узле AST. | [→ helpers.ts:148-162] |
