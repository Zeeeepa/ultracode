...
**🌟 14 языков** | **⚡ В 5.5 раз быстрее** встроенных инструментов Claude | **🔍 Умный поиск** | **📊 70 готовых инструментов**
...
TypeScript, JavaScript, Python, C#, C/C++, Rust, Go, Java, Kotlin, Swift, Zig, Bash, PowerShell
...
| **mlx** | ~2ms | 512-8K | ⭐ macOS Apple Silicon (Metal) |
...
| **C#** | Roslyn: классы, интерфейсы, LINQ, async/await, свойства | ✅ 90% |
| **Kotlin** | Корутины, data classes, sealed classes, расширения | ✅ 90% |
...
| **Swift** | Протоколы, расширения, actors, async/await | ✅ 85% |
| **Zig** | Функции, структуры, comptime, ошибки | ✅ 80% |
| **Bash** | Функции, переменные, подстановки | ✅ 75% |
| **PowerShell** | Cmdlets, функции, модули | ✅ 75% |
...
- **ParserAgent** - AST-парсинг через нативные парсеры (14 языков)
...
- `mlx` (рекомендуется для macOS Apple Silicon) - MLX Metal GPU, автоматический venv + модель
