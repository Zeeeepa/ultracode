...
**Swagger Stale Detection**: For projects with Swagger/OpenAPI, health check also reports when generated code may be out of sync:
...
```typescript
{
  ...
  swaggerHealth: {
    swaggerFilesFound: 2,
    activeContracts: 1,
    staleWarnings: ["Generated code may be out of sync: swagger.json updated after generated/api-client.ts"]
  }
}
```
