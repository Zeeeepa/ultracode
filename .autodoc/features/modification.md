...
**Swagger Contract Warnings**: When modifying entities linked to Swagger/OpenAPI, the response includes `swaggerWarning` and `swaggerImpact` section with contract break details. See [swagger.md](swagger.md).
